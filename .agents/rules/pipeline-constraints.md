...
5. Confirm/reject cleanup must remove completed or deleted entries from `dev/TASK_EXECUTION_PIPELINE.json`; the pipeline remains pending-only after every update.
