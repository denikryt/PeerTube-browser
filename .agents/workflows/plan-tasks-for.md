...
4. Quality Check: Verify compliance with **Gate B: Pre-sync (local decomposition)** in `.agents/protocols/feature-planning-protocol.md`.
5. Only after task decomposition is completely mapped out conceptually and quality check is passed, utilize the CLI to synchronize everything.
