#!/usr/bin/env python3
"""Similarity server API for embeddings, recommendations, and /api/similar.
...
if str(server_dir) not in sys.path:
    # Allow imports from server/ when running this module directly.
...
def main() -> None:
    ...
    db_path = (script_dir.parent.parent / DEFAULT_DB_PATH).resolve()
    index_path = (script_dir.parent.parent / DEFAULT_INDEX_PATH).resolve()
    users_db_path = (script_dir.parent.parent / DEFAULT_USERS_DB_PATH).resolve()
    similarity_db_path = (script_dir.parent.parent / DEFAULT_SIMILARITY_DB_PATH).resolve()
