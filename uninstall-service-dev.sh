...
print_usage() {
  cat <<'EOF_USAGE'
Usage: sudo ./uninstall-service-dev.sh [options] [-- <extra uninstall-service.sh args>]

Dev preset wrapper over uninstall-service.sh.
Defaults:
- mode=dev
- keep updater state
...
Options:
  ...
  --purge-updater-state     Remove dev updater state artifacts
